...
namespace DndApi.Controllers
{
    ...
    public class RulesController(HttpClient client) : ControllerBase
    {
        ...
        public async Task<ActionResult<RulesModel.Conditions.ConditionsList>> GetAllClasses()
        {
            try
            {
                ...
                var conditionsList = await _client.GetFromJsonAsync<RulesModel.Conditions.ConditionsList>($"{baseUrl}/conditions");
